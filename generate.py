...
- Every factual claim must be supported by the provided documents; do not fill gaps with general knowledge or assumptions.
- If the documents do not cover the question, or only cover part of it, say you don't have enough information instead of guessing.
